...
func ResponseStatusCode() {
	CodeMap = map[int64]string{
		...
		1021: "The data is not satisfied of format rule.",
		...
		1052: "mail, mail_otp_verify or username are not exists.",
		...
		1066: "Update personal information failed.",
		1067: "It's either that the mail doesn't exist or password.",
		1068: "The json data marshal failed.",
